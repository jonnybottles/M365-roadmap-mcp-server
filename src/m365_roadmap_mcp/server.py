...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "- release_phase: filter by release ring ('General Availability', 'Preview')\n"
        "- platform: filter by platform ('Web', 'Desktop', 'iOS', 'Android', 'Mac')\n"
        "- rollout_date: filter by general availability date (e.g. '2026-03')\n"
        "- preview_date: filter by preview availability date (e.g. '2026-07')\n"
        ...
        "Output fields include: products, release_rings, general_availability_date, "
        "preview_availability_date, availabilities (per-ring schedule), and more_info_urls.\n\n"
        "Tips:\n"
        ...
        "- To search by dates, use rollout_date or preview_date with YYYY-MM format strings.\n"
